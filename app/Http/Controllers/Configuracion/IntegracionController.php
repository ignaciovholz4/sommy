    ...
    public static function grupos(): array
    {
        return [
            ...
            'mail' => [
                ...
                'icono' => 'fa-envelope',
                'descripcion' => 'Avisos de pedidos a clientes, recupero de contraseña y el mail de verificación que ahora es OBLIGATORIO para que un comprador pueda finalizar una compra en el ecommerce (sin esto configurado, nadie recibe el link y el checkout queda bloqueado para todos). Con MAIL_MAILER=log (el valor de fábrica) el correo NO sale, solo queda escrito en el log del servidor.',
                'campos' => [
                    ['env' => 'MAIL_MAILER', 'label' => 'Mailer', 'secreto' => false, 'ayuda' => 'Poné "smtp" para que salga de verdad. "log" es solo para pruebas: no manda nada.'],
                    ['env' => 'MAIL_HOST', 'label' => 'Servidor SMTP', 'secreto' => false, 'ayuda' => 'Con un correo de tu dominio en Hostinger: smtp.hostinger.com (mirá el mail exacto en hPanel › Correo › Configurar cliente de correo). Con Gmail: smtp.gmail.com'],
                    ['env' => 'MAIL_PORT', 'label' => 'Puerto', 'secreto' => false, 'ayuda' => '465 con Encriptación=ssl, o 587 con Encriptación=tls'],
                    ['env' => 'MAIL_USERNAME', 'label' => 'Usuario', 'secreto' => false, 'ayuda' => 'La casilla completa desde la que se envía, ej: pedidos@tudominio.com'],
                    ['env' => 'MAIL_PASSWORD', 'label' => 'Contraseña', 'secreto' => true, 'ayuda' => 'La de esa casilla de correo. Con Gmail NO es tu contraseña normal: hay que crear una "contraseña de aplicación" en myaccount.google.com/apppasswords'],
                    ['env' => 'MAIL_ENCRYPTION', 'label' => 'Encriptación', 'secreto' => false, 'ayuda' => 'ssl o tls (tiene que combinar con el puerto de arriba)'],
                    ['env' => 'MAIL_FROM_ADDRESS', 'label' => 'Remitente', 'secreto' => false, 'ayuda' => 'La dirección que ve el cliente como remitente — usá la misma casilla del Usuario'],
                ],
