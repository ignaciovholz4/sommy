...
TXT;
    ...
    protected function armarSystem(array $producto, bool $esCombo, string $formato, bool $conPrecio): string
    {
        ...
        $system = "Sos el asistente del Estudio de Publicaciones de Sommy (colchones). Ayudás a crear contenido "
            ...
            . "- El estilo visual de marca (ambientación, luz, paleta) y la fidelidad del colchón real a la foto se aplican SIEMPRE automáticamente en generar_imagenes, no dependen de vos ni hace falta que los menciones.\n"
