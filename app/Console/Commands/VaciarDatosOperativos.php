 ...
 * Chytapay, publicaciones IA, pedidos ecommerce, notificaciones) para arrancar
 * las métricas de 0, sin tocar productos, proveedores, clientes ni usuarios/roles.
 *
...
class VaciarDatosOperativos extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->newLine();
        $this->info('Se conservan intactos: productos/catálogo, proveedores, clientes, usuarios/roles/permisos, sucursales, cajas/bancos, config del sistema.');
        $this->newLine();
