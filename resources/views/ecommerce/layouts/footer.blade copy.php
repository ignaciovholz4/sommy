        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <!--img src="{{asset('imagenes/ecommerce/images/logo.png')}}" alt="logo">-->
              <img src="{{asset($arrayEmpresa['image'])}}" alt="logo empresa" width="50" height="50">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">Devoluciones y reembolsos</a>
                </li>
                <li class="menu-item">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                ...
                @if ($loop->index < 4)
                <li class="menu-item">
                  <a href="{{url('Ecommercecategory', ['id'=> $catL->idcategoria])}}" class="nav-link">{{$catL->nombre}}</a>
                </li>
                @endif
                @endforeach
                <!--li class="menu-item">
          ...
          <!--div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title">Suscríbete a nosotros</h5>
