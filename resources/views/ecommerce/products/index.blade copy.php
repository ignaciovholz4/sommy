...
.product-item-22 figure {
  background-color: aqua;
}
.product-item-22 img {
  object-fit: contain;      /* Ajusta la imagen dentro del contenedor sin distorsionarla */
  max-width: 100%;          /* Asegura que la imagen no sobresalga horizontalmente */
  max-height: 100%;         /* Asegura que la imagen no sobresalga verticalmente */
}
.w-20{
width: 20%;
}
...
<section class="py-5">
  <div class="container-fluid">
    <div class="container">
     ...
     <div class="row">
        <div class="col-md-6">
          <div class="product-item-22">
            <figure>
              @if($getProd[0]->tipo_producto_id == 2)
              <a href="{{$firstMatchVariant->url}}" data-fancybox="gallery" title="Product Title">
                <img src="{{$firstMatchVariant->url}}"  class="" id="showImageVariant">
              </a>
              @elseif($getProd[0]->tipo_producto_id == 1)
              <a href="{{$getProd[0]->mainImage}}" data-fancybox="gallery" title="Product Title">
                <img src="{{$getProd[0]->mainImage}}"  class="" id="showImageVariant">
              </a>
              @else
            ...
            <div class="ps-lg-10 mt-6 mt-md-0">
              ...
              <div class="w-20">
                <div class="input-spinner input-group">
                  <button
                    type="button" id="btnLessCant" class="button-minus text-dark btn btn-danger btn-sm">-</button>
                    <input
                    ...
                    readonly
                    />
                  <button type="button" id="btnAddCantMore" class="button-plus text-dark btn btn-danger btn-sm">+</button>
                </div>
              </div>
              <div class="mt-3 justify-content-start g-2 align-items-center row">
                <div class="d-grid col-xxl-5 col-lg-5 col-md-5 col-5">
                  <button type="button" class="btn btn-danger" id="btn-add-product">
                    <svg
