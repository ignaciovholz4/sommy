                ...
                <div class="compra-head-grid">
                    <div class="form-group">
                        ...
                        <div style="display:flex;gap:6px;">
                            ...
                            <button type="button" class="btn btn-outline-primary" onclick="abrirAltaRapida_qprovPedido()" title="Crear proveedor rápido">
                                <i class="fas fa-plus"></i>
                            </button>
                        </div>
                    </div>
                    @include('partials.alta_rapida', ['arPrefijo' => 'qprovPedido', 'arTitulo' => 'Crear proveedor rápido', 'arRuta' => route('quick_create_supplier'), 'arSelect' => 'proveedor_id', 'arKey' => 'supplier', 'arPk' => 'idproveedor'])
